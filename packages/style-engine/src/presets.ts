...
export const presets: Preset[] = [
  {
    ...
    terrain: { enabled: true, hillshade: true, contours: true, intensity: 0.75, satellite: false },
    ...
    sky: { color: "#A8D5E8", horizonColor: "#F5EFE0", grainEnabled: false },
  },
  {
    id: "midnight-terrain",
    ...
    terrain: { enabled: false, hillshade: false, contours: false, intensity: 0, satellite: false },
    layers: { buildings: true, parks: true, water: true, buildings3d: false },
    borders: { country: true, region: false },
    labels: { cities: true, roads: false, poi: false, scale: 1 },
    sky: { color: "#050914", horizonColor: "#1A2740", grainEnabled: false },
  },
  {
    id: "paper-atlas",
    name: "Paper Atlas",
    ...
    terrain: { enabled: true, hillshade: false, contours: true, intensity: 0.35, satellite: false },
    layers: { buildings: true, parks: true, water: true, buildings3d: false },
    borders: { country: true, region: true },
    labels: { cities: true, roads: false, poi: false, scale: 1 },
    sky: { color: "#DCE8E6", horizonColor: "#F7F2E7", grainEnabled: false },
  },
  {
    id: "slate",
    name: "Slate",
    ...
    borders: { country: true, region: false },
    labels: { cities: true, roads: false, poi: false, scale: 1 },
    sky: { color: "#D7DEE3", horizonColor: "#F5F6F7", grainEnabled: false },
  },
  {
    id: "sandstone",
    name: "Sandstone",
    ...
    terrain: { enabled: true, hillshade: true, contours: false, intensity: 0.6, satellite: false },
    layers: { buildings: true, parks: true, water: true, buildings3d: false },
    borders: { country: true, region: false },
    labels: { cities: true, roads: false, poi: false, scale: 1 },
    sky: { color: "#F5D9A8", horizonColor: "#F2E2C8", grainEnabled: false },
  },
  {
    id: "arctic",
    name: "Arctic",
    ...
    terrain: { enabled: true, hillshade: true, contours: true, intensity: 0.3, satellite: false },
    layers: { buildings: true, parks: true, water: true, buildings3d: false },
    borders: { country: true, region: false },
    labels: { cities: true, roads: false, poi: false, scale: 0.95 },
    sky: { color: "#DCEEF7", horizonColor: "#F4FAFC", grainEnabled: false },
  },
  {
    id: "neon-grid",
    name: "Neon Grid",
    ...
    sky: { color: "#050208", horizonColor: "#0D0B1A", grainEnabled: false },
  },
  {
    id: "forest-canopy",
    name: "Forest Canopy",
    ...
    terrain: { enabled: true, hillshade: true, contours: true, intensity: 0.7, satellite: false },
    layers: { buildings: true, parks: true, water: true, buildings3d: false },
    borders: { country: true, region: true },
    labels: { cities: true, roads: false, poi: false, scale: 1 },
    sky: { color: "#3A5A45", horizonColor: "#213823", grainEnabled: false },
  },
];
